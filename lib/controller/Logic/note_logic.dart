...
class AppRoute {
  ...
  static void goReset(BuildContext context){
  }
  static void customShowDialog({required BuildContext context , String ?content ,String ?title ,IconData ? icondata }) {
  ...
  static Future<void> showSnack({ required BuildContext context , String ?content})async{
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(content!),behavior: SnackBarBehavior.floating,duration: const Duration(seconds: 1),)
    ) ;
  }


  static void chooseImage({required BuildContext context , String ? title , String ? galleryContent , String ? cameraContent ,void Function()? onCamera ,void Function()? onGallery}) {
