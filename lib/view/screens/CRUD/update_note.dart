...
class UpdateNote extends StatelessWidget {
  ...
  final updateController = Get.lazyPut(
  ...
  Widget build(BuildContext context) {
    return GetBuilder<UpdateNoteController>(
      builder: (c) {
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: GetBuilder<UpdateNoteController>(
                          builder: (c) =>
                              (updateNoteController.editImageUrl == null ||
                      ...
                      Padding(
                        ...
                        child: Directionality(
                          textDirection:
                              detectLanguage(
                                    c.editNoteTitle ??
                                        updateNoteController.note!.noteTitle,
                                  ) ==
                                  TextDirection.rtl
                              ? TextDirection.rtl
                              : TextDirection.ltr,
                      ...
                      Padding(
                        ...
                        child: Directionality(
                          textDirection:
                              detectLanguage(
                                    c.editNoteContent ??
                                        updateNoteController.note!.noteContent,
                                  ) ==
                                  TextDirection.rtl
                              ? TextDirection.rtl
                              : TextDirection.ltr,
