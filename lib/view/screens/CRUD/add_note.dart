          ...
          bottomNavigationBar: GetBuilder<AddNoteController>(
            builder: (controller) => NavigationBar(
              ...
              destinations: [
                ...
                NavigationDestination(
                  icon: Icon(Icons.work_rounded, size: 30, color: Colors.teal),
                  label: 'work'.tr,
                ),
                NavigationDestination(
                  icon: Icon(
              ...
              GetBuilder<AddNoteController>(
                builder: (c) => Visibility(
                  ...
                  visible: noteTitle.text == "" && noteContent.text == ""
                      ...
                      : true,
                  child: IconButton(
                    onPressed: noteTitle.text == "" && noteContent.text == ""
                        ? null
                        : () async {
                            if (formState.currentState!.validate()) {
                              ...
                              c.addNoteToDatabase(
                                ...
                                contentSize: c.controller.getContentSize,
              ...
              Padding(
                ...
                child: GetBuilder<AddNoteController>(
                  builder: (c) => Directionality(
                    textDirection:
                        detectLanguage(noteTitle.text) == TextDirection.rtl
                        ? TextDirection.rtl
                        : TextDirection.ltr,
                    child: TextFormField(
                      textAlign: detectLang(noteTitle.text) == TextAlign.right
                          ? TextAlign.right
                          : TextAlign.left,
                      onChanged: (val) {
                        addNoteController.refreshGet();
              ...
              Padding(
                ...
                child: GetBuilder<AddNoteController>(
                  builder: (controller) => Directionality(
                    textDirection:
                        detectLanguage(noteContent.text) == TextDirection.rtl
                        ? TextDirection.rtl
                        : TextDirection.ltr,
                    child: TextFormField(
                      textAlign: detectLang(noteContent.text) == TextAlign.right
                          ? TextAlign.right
                          : TextAlign.left,
                      onChanged: (val) {
                        addNoteController.refreshGet();
                      ...
                      style: TextStyle(
                        ...
                        fontStyle: addNoteController.controller.fontStyle,
                        fontWeight: addNoteController.controller.fontWeight,
                      ),
