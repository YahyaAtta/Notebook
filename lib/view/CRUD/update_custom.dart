...
class UpdateCustom extends StatefulWidget {
  const UpdateCustom({super.key});

  @override
  State<UpdateCustom> createState() => _UpdateCustomState();
}
...
class _UpdateCustomState extends State<UpdateCustom> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Update Customize"),
        centerTitle: true,
        actions: [
          IconButton(
              tooltip: 'Update Done',
        ...
        children: [
          Consumer<NotesModel>(
            builder: (context, notes, child) =>
              ...
              const Text("Update Content Font Size"),
              Column(
                children: [
                  IconButton(
                      onPressed: () {
